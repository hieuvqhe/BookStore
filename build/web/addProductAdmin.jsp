                ...
                <div class="row">
                    <div class="col-lg-8 col-sm-12">
                        <div class="">
                            ...
                            <form name="adminAddProduct" action="adminAddProduct" method="post">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="name">Id Product: </label>
                                            <input type="text" class="form-control" id="name" name="pid" required data-error="Please enter your name">
                                   ...
                                   <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="name" name="description" required data-error="Please enter your name">
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="1" step="0.2" class="form-control" name="price" required data-error="Please enter your name">
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="1" step="1" class="form-control" name="quantity" required data-error="Please enter your name">
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="submit-button text-center">
                                            <button class="btn hvr-hover" type="submit">ADD TO PRODUCT</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
