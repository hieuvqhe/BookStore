                                        ...
                                        <tr>
                                            ...
                                            <td class="quantity-box">
                                                <form action="quantityCard?pid=${cart.pid}">
                                                    ...
                                                    <button type="submit" formaction="quantityCard" formmethod="get"  class="btn btn-danger btn-sm" ${cart.quantity == 0 ? 'disabled' : ''}> - </button>
                                                    ${cart.quantity}
                                                    <button type="submit" formaction="quantityCard" formmethod="post" class="btn btn-success btn-sm" ${cart.quantity >= productQuantities[cart.pid] ? 'disabled' : ''}> + </button>
