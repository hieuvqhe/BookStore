    ...
    <body id="shop-container">
        ...
        <div class="all-title-box">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <h2 id="titleCategory">Statistic</h2>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="home">Home</a>/Statistic</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-xl-9 col-lg-9 col-sm-12 col-xs-12 shop-content-right">
                        <div class="right-product-box">
                            <center>
                                <h1 class="pt-3 pb-3 border-b"><b>TOP3 BEST SELLER</b></h1>
                            </center>
                                    ...
                                    <div class="product-categorie-box">
                                        <div class="tab-content">
                                            <div role="tabpanel" class="tab-pane fade show active" id="grid-view">
                                                <div class="row">
                                                    <c:forEach var="book" items="${top5Product}">
                            ...
                            <section class="pt-10">
                                <center>
                                    <h1 class="pt-3 pb-3"><b>TOP 10 CUSTOMER</b></h1>
                                </center>
                                ...
                                <table class="table">
                                    ...
                                    <c:forEach items="${top10User}" var="acc">
                                        <tr>
                                            <td>${acc.username}</td>
                                            <td>${acc.fullname}</td>
                                            <td>${acc.email}</td>
