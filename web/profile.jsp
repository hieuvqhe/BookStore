                ...
                <div class="row">
                    <div class="col-lg-8 col-sm-12">
                        <div class="contact-form-right">
                            ...
                            <p></p>
                            <form id="updateForm" name="updateForm" action="profile" method="post" onsubmit="return validateForm() && showSuccessMessage()" data-value="<c:out value="${currAcc.password}"/>">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="name">Fullname:</label>
                                            <input type="text" class="form-control" id="name" name="name" required data-error="Please enter your name" value="${currAcc.fullname}" readonly>
